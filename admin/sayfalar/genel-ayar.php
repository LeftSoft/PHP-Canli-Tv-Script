...
<div class="row">
            ...
            <div class="card card-primary card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Logo Ayarı</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-one-messages-tab" data-toggle="pill" href="#custom-tabs-one-messages" role="tab" aria-controls="custom-tabs-one-messages" aria-selected="false">Favicon Ekle</a>
                  </li>
 ...
 <div class="col-sm-12">
    ...
    <button type="submit" name="logoduzenle" class="btn btn-success">Düzenle</button>
</form>
                  </div>
 ...
 <div class="form-group">
    ...
    <button type="submit" name="genelayarkaydet" class="btn btn-success">Düzenle</button>
             ...
             <div class="col-sm-12">
                      <div class="form-group">
                        <label>Yüklü Fovicon</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">

                   <?php 
                    if (strlen($ayarcek['ayar_fovicon'])>0) {?>

                    <img width="50"  src="../../<?php echo $ayarcek['ayar_fovicon']; ?>">
 ...
 <div class="col-sm-12">
                    ...
                    <input type="hidden" name="eski_yol" value="<?php echo $ayarcek['ayar_fovicon']; ?>">
<br>
    <button type="submit" name="foviconguncelle" class="btn btn-success">Düzenle</button>
</form>
                  </div>
